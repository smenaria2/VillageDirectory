...
export default function SearchPage() {
  ...
  const { data: businesses = [], isLoading } = useQuery<Business[]>({
    queryKey: ["businesses", { category: selectedCategory, search: debouncedQuery }],
    queryFn: async () => {
      let query = supabase
        .from('businesses')
        .select('*')
      ...
      if (debouncedQuery) {
        query = query.or(`name.ilike.%${debouncedQuery}%,description.ilike.%${debouncedQuery}%,category.ilike.%${debouncedQuery}%`);
      }
